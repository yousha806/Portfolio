            ...
            <div className='hidden sm:flex'>
              <nav className="flex justify-end items-center">
                <ul className="flex flex-row justify-end items-center list-none space-x-4 font-bold">
                  ...
                  <li><Link href="https://drive.google.com/file/d/11HhZuUzQ_3glcgw8XlZSPgTwatNdKlZC/view?usp=sharing" target='_blank' rel="noreferrer" className='hover:underline'>Resume</Link></li>
            ...
            <div className={`sm:hidden flex flex-row space-x-4 items-center`}>
              ...
              <Sidebar isOpen={isOpen} setIsOpen={setIsOpen}>
                <div className={`flex flex-col h-full w-48 ${darkMode ? 'dark bg-slate-100' : 'light bg-slate-800'} transition ease-in-out duration-500`}>
                  ...
                  <Link href="https://drive.google.com/file/d/11HhZuUzQ_3glcgw8XlZSPgTwatNdKlZC/view?usp=sharing" target='_blank' className={`flex w-full justify-center text-center px-4 py-2 text-white dark:text-slate-500 hover:bg-slate-700 dark:hover:bg-slate-200 hover:underline`} onClick={()=>setIsOpen(false)}> Resume </Link>
